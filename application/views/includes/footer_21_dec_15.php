<div id="footer-large">
    <div id="footer" role="contentinfo clearfix" class="non-burger-footer">
            ...
            <div class="marketing_message_footer" class="slider">
                ...
                <div>
                    <div data-slotid="footer-marketing-banner-3" class="html-slot-container">
                        <div>
                            <div class="pannel" data-desc="Create an account at shop.diesel.com. Enjoy 15% off your first online order. &lt;a href=&quot;
                                <?=base_url().'member/register'?>&quot&gt;REGISTER HERE&lt;/a&gt;, you'll get your coupon code via email." data-title="REGISTER FOR EXCLUSIVE BENEFITS">
        ...
        <div class="content-asset">
            ...
            <footer>
                <!--<div id="footer-over"><div id="footer-overlay"></div><div id="footer-overlay-tab" class="footer-overlay-menu"><ul class="footer-menu"><li data-target="1" class="col-xs-3"><a class=""><h5>SHIPPING INFO & SUPPORT</h5></a></li><li data-target="2" class="col-xs-3"><a class=""><h5>WORLD OF DIESEL</h5></a></li><li data-target="3" class="col-xs-3"><a class=""><h5>FOLLOW US</h5></a></li><li data-target="4" class="col-xs-3"><a class=""><span><h5 class="footer-sign-up">SIGN UP FOR THE NEWSLETTER</h5><input readonly type="text" class="sign-up"/></span></a></li></ul></div></div>-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <ul class="footer-links active-accordian-tab">
                                                <li class="footer-links-responsive">
                                                    <a href="https://shop.diesel.com/orders#check-order">
                                                        <h6>Track Order</h6>
                                                    </a>
                                                </li>
                                                <li class="footer-links-responsive">
                                                    <a data-dlg-action='{"test":100}' data-dlg-options='{"width":"80%","height":"500","dialogClass":"dialog-footer-shipping"}' class="open-dialog" href="https://shop.diesel.com/cms/help/shipping/shippingtimescosts.html">
                                                        <h6>Shipping</h6>
                                                    </a>
                                                </li>
                                                <li class="footer-links-responsive">
                                                    <a data-dlg-action='{"test":100}' data-dlg-options='{"width":"80%","height":"500","dialogClass":"dialog-footer-return"}' class="open-dialog" href="https://shop.diesel.com/cms/help/returns.html">
                                                        <h6>Returns</h6>
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <ul class="footer-links accordian-tab">
                                                <li class="footer-links-responsive">
                                                    <a href="
                                                        <?=base_url();?>info/sizeguide">
                                                        <h6>Size Guide</h6>
                                                    </a>
                                                </li>
                                                <li class="footer-links-responsive">
                                                    <a href="
                                                        <?=base_url();?>info/paymentmethods">
                                                        <h6>Payment</h6>
                                                    </a>
                                                </li>
                                                <li class="footer-links-responsive">
                                                    <a href="
                                                        <?=base_url();?>info/contactus">
                                                        <h6>Contact Us</h6>
                                                    </a>
                                                </li>
                                            </ul>
               ...
               &nbsp;
                                                ...
                                                <ul class="footer-links accordian-tab">
                                                    <li class="footer-links-responsive">
                                                        <a href="
                                                            <?=base_url();?>info/termsandconditions">
                                                    ...
                                                    <li class="footer-links-responsive">
                                                        <a href="
                                                            <?=base_url();?>info/privacypolicy">
                                                            <h6>Privacy Policy</h6>
                                                        </a>
                                                    </li>
                                                    <li class="footer-links-responsive">
                                                        <a href="
                                                            <?=base_url();?>info/sitemap">
                                                            <h6>Site Map</h6>
                                                        </a>
                                                    </li>
                                                    <?php } ?>
    ...
    &nbsp;
               ...
               &nbsp;
                                        ...
                                        <div class="row">
                                            <div class="col-lg-1 col-lg-offset-4 ">
                                                ...
                                                <div class="col-md-1">
                                                    <a target="_blank" href="https://twitter.com/diesel" target="_blank" class="twitter">Twitter</a>
                                                </div>
                                            </div>
                                            <div class="col-lg-1 ">
                                                <div class="col-md-1">
                                                ...
                                                <div class="col-md-1">
                                                    <a target="_blank" href="http://instagram.com/diesel" target="_blank" class="instagram">Instagram</a>
                                                </div>
                                            </div>
                                            <div class="col-lg-1 ">
                                                <div class="col-md-1">
                                                    <a target="_blank" href="http://www.youtube.com/user/DieselPlanet" class="youtube">Youtube</a>
                                                </div>
                                                <div class="col-md-1">
                                                    <a target="_blank" href="http://www.pinterest.com/diesel/" target="_blank" class="pinterest">Pinterest</a>
                                                </div>
                                            </div>
                                            <div class="col-lg-1 ">
                                                <div class="col-md-1">
                                                    <a target="_blank" href="http://dieselreboot.tumblr.com/" class="socialIcon">Social Icon</a>
                                                </div>
                                                <div class="col-md-1">
                                                    <a target="_blank" href="http://dieselreboot.tumblr.com/" target="_blank" class="tumbler">Tumbler</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
               ...
               &nbsp;
                  ...
                  &nbsp;
                        ...
                        <?php } ?>
                        <!--  <div id="footer-scroll-fixed-tab" class="footer-scroll-fixed-menu"><span id="footer-menu-4" class="footer-menu-4 footer-menu col-md-3 border-side-top" data-target="4"><span><h5 class="footer-sign-up">SIGN UP FOR THE NEWSLETTER</h5><input type="text" class="sign-up"/></span></span><span id="footer-menu-3" class="footer-menu-3 footer-menu col-md-3 border-side-top" data-target="3"><h5>FOLLOW US</h5></span><span id="footer-menu-2" class="footer-menu-2 footer-menu col-md-3 border-side-top" data-target="2"><h5>WORLD OF DIESEL</h5></span><span id="footer-menu-1" class="footer-menu-1 footer-menu col-md-3 border-side-top" data-target="1"><h5>SHIPPING INFO & SUPPORT</h5></span></div>-->
                        <div class="storefront-mobile-menu">
                            <h5 class="footer-sign-up">
                                <a href="https://shop.diesel.com/storelocator" target="_blank">STORE LOCATOR</a>
                            </h5>
                        </div>
                    </div>
                </footer>
	...
	<script src="<?=base_url()?>js/custom.js" type="text/javascript">
    </script>
    ...
    <script src="<?php echo base_url(); ?>js/packery-mode.pkgd.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/imagesloaded.pkgd.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/persist-all-min.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/diesel.plugins.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/carousel.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/hammer.min.js" type="text/javascript"></script>
    ...
    <script src="<?php echo base_url(); ?>js/backgroundVideo.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/jquery.tooltipster.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/jquery.inViewport.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/scoped.js" type="text/javascript"></script>
    ...
    <script type="text/javascript" src="<?=base_url();?>js/addthis_widget.js#pubid=ra-524670f854b3d609">
    </script>
    <script src="<?=base_url();?>js/app.js" type="text/javascript">
    </script>
    <script src="<?=base_url();?>js/common.js" type="text/javascript">
    </script>
    <script src="<?=base_url();?>js/diesel.app.js" type="text/javascript">
    </script>
    <script>
      app.page.setContext({
        "title": "My Account",
    ...
    <script id="mstag_tops" type="text/javascript" src="<?=base_url();?>js/mstag.js">
    </script>
    <script type="text/javascript">
...
<script type="text/javascript" src="<?=base_url();?>js/dwanalytics.js">
</script>
<script type="text/javascript">
    //
    <!--
